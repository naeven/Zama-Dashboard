...
export default async function handler(req, res) {
    ...
    try {
        ...
        if (cached && cached.cached_at && !force) {
            ...
            // If cache is fresh (< TTL), return it immediately
        ...
        if (isLocked) {
            ...
            return res.status(429).json({ error: 'System busy, syncing in progress.' });
        }
        ...
        try {
            ...
            while (attempts < 15) { // Poll for max ~30 seconds
                ...
                if (statusResp.status === 200) {
                    ...
                    if (finalData.state === 'QUERY_STATE_COMPLETED') break;
